...
A TODO feladatok külön nézetben kerülnek kilistázásra. Új feladatot egyszerűen vehet fel a felhasználó, megadhat hozzá egy határidőt, az adott feladatot egy checkbox kipipálásával elvégzettnek jelölheti, vagy törölheti.
